...
// Cyberpunk / sci-fi prefix pool. Pure technical / synthetic
// vocabulary — no fantasy holdovers ("Vorpal", "Howling", etc.). ~28
// entries so nearby drops rarely repeat.
